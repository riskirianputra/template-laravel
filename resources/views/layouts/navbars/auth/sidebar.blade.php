...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/efektifpro.png"  alt="..." width="100%" >        
    </a>
  </div>
        ...
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Laravel Examples</h6>
            ...
            <!-- <li class="nav-item pb-2">
              <a class="nav-link {{ (Request::is('galery') ? 'active' : '') }}" href="{{ url('galery') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style="font-size: 1rem;" class="fas fa-images {{ (Request::is('galery') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                  </div>
            ...
            <li class="nav-item pb-2">
              <a class="nav-link {{ (Request::is('project') ? 'active' : '') }}" href="{{ url('project') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style="font-size: 1rem;" class="fas fa-tv fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('project') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                  </div>  
            ...
            <li class="nav-item pb-2">
              <a class="nav-link {{ (Request::is('about') ? 'active' : '') }}" href="{{ url('about') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style="font-size: 1rem;" class="fas fa-stamp fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('about') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                  </div>
